...
from keypad2 import constantList, functionList
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        constantList_dic = {constantList[0]: '3.141592', constantList[1]: '3E+8', constantList[2]: '340', constantList[3]: '1.5E+8'}
        functionList_dic = {functionList[0] : ''}
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantList_dic[key])
            '''
            ...
            n = self.display.text()
            functionList_dic = {functionList[0]:str(calcFunctions.factorial(n)), functionList[1]:str(calcFunctions.decToBin(n)), functionList[2]:str(calcFunctions.binToDec(n)), functionList[3]:str(calcFunctions.decToRoman(n))}
            value = functionList_dic[key]
