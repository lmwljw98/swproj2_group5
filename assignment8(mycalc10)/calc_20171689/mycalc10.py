...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        buttonGroups = {
            'num': {'buttons': numPadList, 'layout': numLayout, 'columns': 3, 'rows': 4},
            'op': {'buttons': operatorList, 'layout': opLayout, 'columns': 2, 'rows': 4},
            'constants': {'buttons': constantList, 'layout': constLayout, 'columns': 1, 'rows': 4},
            'functions': {'buttons': functionList, 'layout': funcLayout, 'columns': 1, 'rows': 4},
        }
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            result = str(self.display.parsedText())
